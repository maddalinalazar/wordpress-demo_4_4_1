...
class EALogic
{
	 ...
	 */
	public function get_open_slots($location = null, $service = null, $worker = null, $day = null, $app_id = null, $check_current_day = true, $block_time = 0)
	{
		global $wpdb;
	...
	public function can_make_reservation($ip)
	{
		...
		$maxNumber = (int)self::get_option_value('max.appointments', 1);

		return (count($appIds) <= $maxNumber);
	}
