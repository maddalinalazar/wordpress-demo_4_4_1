...
require_once EA_SRC_DIR . DIRECTORY_SEPARATOR . 'fields' . DIRECTORY_SEPARATOR . 'appointment.php';
...
class EAAjax
{
	...
	public function ajax_date_selected()
	{
		...
		$slots = $logic->get_open_slots($_GET['location'], $_GET['service'], $_GET['worker'], $_GET['date'], null, true, $block_time);
